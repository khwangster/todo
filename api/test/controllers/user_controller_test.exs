defmodule App.UserControllerTest do
  ...
  test "shows chosen resource", %{conn: conn} do
    ...
    assert data["attributes"]["slack_user_id"] == user.slack_user_id
    assert data["attributes"]["name"] == user.name
    assert data["attributes"]["last_emailed_task_id"] == user.last_emailed_task_id
    assert data["attributes"]["enabled"] == user.enabled
  end
